...
<div class="wrap" >  
    ...
    <div class="aal_leftadmin">	
		...
		<p>To let the plugin to automatically get links and add them to product references or important keywords in your posts, you have to go to our website and <a href="http://autoaffiliatelinks.com/wp-login.php?action=register">get your API key</a>. Then, go to "Upgrade to PRO" menu and add your API key there. On the same page you can activate the affiliate networks you want to get links from: Amazon, Clickbank, Ebay, Shareasale, Walmart, Commission Junction, Bestbuy and Envato Marketplace.</p>
