...
function wpaal_manage_affiliates() {
	...
	<br /><br /> -->
        ...
        <div class="aal_panes">
			...
			Separator: <input type="aal_import_separator" type="text" value="|"/><br />
